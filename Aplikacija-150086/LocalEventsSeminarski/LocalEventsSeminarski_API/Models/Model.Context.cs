...
namespace LocalEventsSeminarski_API.Models
{
    ...
    public partial class LocalEventsEntities : DbContext
    {
        public LocalEventsEntities()
            : base("name=LocalEventsEntities")
        {
        }
        ...
        public virtual ObjectResult<Korisnik_Select_Result> esp_Korisnik_SelectByImePrezime(string imePrezime)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Korisnik_Select_Result>("esp_Korisnik_SelectByImePrezime", imePrezimeParameter);
        }
        ...
        public virtual ObjectResult<Nullable<decimal>> esp_Organizacija_Insert(string naziv, string opis, string tip, Nullable<int> gradID)
        {
            var nazivParameter = naziv != null ?
                new ObjectParameter("Naziv", naziv) :
                new ObjectParameter("Naziv", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<Nullable<decimal>>("esp_Organizacija_Insert", nazivParameter, opisParameter, tipParameter, gradIDParameter);
        }
        ...
        public virtual ObjectResult<esp_AgeRange_SelectAll_Result> esp_EventAgeRange_GetByEvent(Nullable<int> eventID)
        {
            var eventIDParameter = eventID.HasValue ?
                new ObjectParameter("EventID", eventID) :
                new ObjectParameter("EventID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<esp_AgeRange_SelectAll_Result>("esp_EventAgeRange_GetByEvent", eventIDParameter);
        }
        ...
        public virtual ObjectResult<EventToVisit_GetByPosjetilacID_Result> esp_EventToVisit_GetByPosjetilacID(Nullable<int> posjetilacID)
        {
            var posjetilacIDParameter = posjetilacID.HasValue ?
                new ObjectParameter("PosjetilacID", posjetilacID) :
                new ObjectParameter("PosjetilacID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<EventToVisit_GetByPosjetilacID_Result>("esp_EventToVisit_GetByPosjetilacID", posjetilacIDParameter);
        }
        ...
        public virtual ObjectResult<esp_Event_Top5ByGradMjesec_Result1> esp_Event_Top5ByGradMjesec(Nullable<int> gradID, Nullable<int> mjesec)
        {
            var gradIDParameter = gradID.HasValue ?
                new ObjectParameter("GradID", gradID) :
                new ObjectParameter("GradID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<esp_Event_Top5ByGradMjesec_Result1>("esp_Event_Top5ByGradMjesec", gradIDParameter, mjesecParameter);
        }
